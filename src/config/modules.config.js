...
const modules = [
  ...
  // Próximos módulos, siguiendo el mismo patrón:
  // { nombre: 'vendedores', basePath: '/api/vendedores', router: require('../modules/vendedores/routes') },
  // { nombre: 'pedidos', basePath: '/api/pedidos', router: require('../modules/pedidos/routes') },
  // { nombre: 'usuarios', basePath: '/api/usuarios', router: require('../modules/usuarios/routes') },
